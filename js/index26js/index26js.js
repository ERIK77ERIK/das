...
// // լոգիկան while-ի և for-ի լրիվ նույնա, ուղղակի for-ը while loop-ի երեք մասը (այսինքն  փոփոխական ստեղծելը, բուլյան արժեքի ստուգումը, և էտ փոփոխականը ամեն ցիկլից հետո փոխելը  ձևաորում է մի տեղ) որպեսզի ավելի հեշտ կարդացվի, ավելի կոկիկ լինի
...
// i++ -ը սկզբից պահպանում է իր արժեքը հետո նոր է ստանում էտ +1 -ը այսինքն եթե մենք վերագրենք i++ -ը x-ին մենք վերագրում ենք i-ի արժեքը որովհետև ինքը սկզբից i-ն է ընդունում հետո նոր է ++ արվում հետևաբար x-ի արժեքը կլինի 0 
...
// իրականում այսպիսի գործողություն գրեթե երբեք չի արվում, հետևաբար սկզբից ++ անելը լրիվ անիմաստա
...
// նենց որ մի օգտագործեք պետք չի, օգտագործեք i++ կամ i--
